...
class AuthController extends nk_node_library_1.Controllers.BaseController {
    constructor() {
        ...
        this.confirmationToken = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { body } = req;
            const request = res.locals.request;
            try {
                console.log(request, body);
                const response = yield this.service.confirmationToken(request, body);
        ...
        this.me = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const request = res.locals.request;
            res.status(200).send(yield this.service.getMe(request));
        });
        this.sendConfirmationToken = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const request = res.locals.request;
            res.status(201).send(yield this.service.sendConfirmationToken(request));
        });
